    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < anzEarthquakes; i++) {
                ...
                Earthquake earthquake = new Earthquake(time, place, magnitude);
